...
'''
TODO check their paper Inference settings, replace our current object detection 

OUTPUT: json file with ground truth depth distance + object detection for our label
'''

# PATHS
MODEL_PATH = r"C:\Python\ObjectDetectRequireFile\put-in-obj-detect\models\best-lan2.pt"     # model object detection path
