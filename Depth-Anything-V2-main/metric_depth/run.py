...
'''
Apply for Outdoor (VKITTI2) case with model "depth_anything_v2_metric_vkitti_vits.pth"
Run this code 
...
Input: img + model
Output: Absolute depth in meters image (can grayscale or color-visualize)
