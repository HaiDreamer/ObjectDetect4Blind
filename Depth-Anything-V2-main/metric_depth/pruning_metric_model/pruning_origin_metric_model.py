...
'''
Use this after rank_vits_block_metric_depth, this ensure which is the least affected vits block
'''
...
BLOCK_TO_PRUNE = 10                 # choose 0..11, least affected is block 10
MAX_DEPTH_METERS = 80.0             # VKITTI outdoor metric models use 80m
INPUT_SIZE = 518                    # default image size, 518 is “nice” for ViT patch size 14 (514 = 14 * 37)
...
def strip_module_prefix(state_dict):
    """Support for load checkpoint. If keys are like 'module.xxx', strip 'module.' for single-GPU loading."""
...
# Save checkpoint (include metadata so can reload correctly later)
