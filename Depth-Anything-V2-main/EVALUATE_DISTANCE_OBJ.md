...
- In ≈2.6% of detected objects, the KITTI LiDAR GT inside that bounding box had no valid depth points (or the bbox was too tiny), so we excluded them from distance-error statistics.
GT distance (m):
  mean:   26.247
  median: 21.834
  min:    2.711
