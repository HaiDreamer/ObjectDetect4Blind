...
# NOTE: fix your actual file model path
state_dict = torch.load(f'C:/Python/Deep Learning-in class/Depth-Anything-V2-main/checkpoints/depth_anything_v2_{encoder}.pth', map_location="cpu")
