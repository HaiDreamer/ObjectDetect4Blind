...
if __name__ == '__main__':
    ...
    depth_anything.load_state_dict(torch.load(f'C:/Python/ObjectDetect4Blind/Depth-Anything-V2-main/checkpoints/depth_anything_v2_{args.encoder}.pth', map_location='cpu'))
