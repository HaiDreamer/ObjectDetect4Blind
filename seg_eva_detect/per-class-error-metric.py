...
Class                              N    mean|e|     med|e|   mean(gt-p)    med(gt-p)        MSE       RMSE   meanRel%    medRel%
--------------------------------------------------------------------------------------------------------------------------------
crosswalk                          2      0.037      0.037       -0.025       -0.025      0.002      0.045       0.27       0.27
sidewalk                          68      0.333      0.336        0.233        0.310      0.151      0.388       5.20       5.34
stairs                            31      3.185      2.828       -0.061       -0.274     15.276      3.909      18.33      16.24
tree line                         42      0.974      0.615       -0.242        0.365      1.578      1.256      21.04       9.12
...
JSON_PATH = ROOT / "seg_depth_with_pred_pruned1layer.json"
